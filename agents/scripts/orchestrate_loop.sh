...
reload_model_config() {
  ...
  START_RUNNER="${START_RUNNER:-gemini}"
  START_MODEL="${START_MODEL:-gemini-3.1-pro-preview}"
  START_EFFORT="${START_EFFORT:-high}"
  START_FALLBACK_RUNNER="${START_FALLBACK_RUNNER:-codex}"
  START_FALLBACK_MODEL="${START_FALLBACK_MODEL:-gpt-5.4}"
  ...
  TROUBLE_MODEL="${TROUBLE_MODEL:-gpt-5.3-codex-spark}"
