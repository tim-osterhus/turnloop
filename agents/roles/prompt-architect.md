...
- `agents/work/task.md`
- `agents/outline.md`
- `agents/orchestrate_historylog.md` (for recent context, if needed)
...
<prompt id="###-slug" task="<short title>">
  ...
  <context>
    Bullet list of repo facts and constraints, including applicable rules from `rules.md`.
  </context>
  <requirements>
...
- Carry forward any one-game-at-a-time and shared-touchpoint constraints that apply from `rules.md`.
